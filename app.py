...
def extract_high_impact_events(html_content, timezone_source):
    ...
    for row in rows:
        ...
        try:
            ...
            # Localisation -> UTC (Gestion du UTC+1)
...
st.markdown("""
L'application convertit vos heures locales en **UTC strict** pour éviter tout décalage.
""")

# Sélection de la timezone (Europe/Paris = UTC+1)
...
if uploaded_file:
    ...
    with st.spinner('Analyse et conversion UTC...'):
